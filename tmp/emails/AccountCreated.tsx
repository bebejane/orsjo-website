...
const AccountCreated: Template<AccountCreatedProps> = ({ name }) => (
	<BaseLayout width={600} preview='Excited to help you enjoy great meals.'>
		...
		<MjmlSection paddingLeft={spacing.s7} paddingRight={spacing.s7}>
			<MjmlColumn>
				...
				<Text paddingTop={spacing.s7}>
					Starta din dag under Stockholm Design week med en riktigt designboost! Vi introducerar en
					nyhet varje morgon under veckan och bjuder samtidigt på en riktigt bra frukost från
					Fabrique stenugnsbageri. Varje morgon presenterar en av våra formgivare en ny produkt.
					<p>
						Tisdag 7 februari: Sun badrumslampa av Addi
						<br />
						Onsdag 8 februari: Ranka av Jonas Bohlin
						<br />
						Torsdag 9 februari: Cake av Lars Bülow
						<br />
					</p>
				</Text>
		...
		<MjmlSection cssClass='green' backgroundColor={colors.green}>
			<MjmlColumn>
				<MjmlImage align='center' src='https://www.datocms-assets.com/62617/1667455852-vinge.jpg' />
			</MjmlColumn>{' '}
