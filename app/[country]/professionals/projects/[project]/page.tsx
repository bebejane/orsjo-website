...
export default async function Project({ params }: PageProps<'/[country]/professionals/projects/[project]'>) {
...
export async function generateMetadata({
	params,
}: PageProps<'/[country]/professionals/projects/[project]'>): Promise<Metadata> {
	const { project: slug } = await params;
	const { project } = await apiQuery(ProjectDocument, {
		variables: { slug },
	});
