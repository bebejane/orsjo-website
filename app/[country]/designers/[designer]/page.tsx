...
import { buildMetadata } from '@/app/[country]/layout';
import { Metadata } from 'next';

export default async function Designer({ params }: PageProps<'/[country]/designers/[designer]'>) {
...
export async function generateMetadata({ params }: PageProps<'/[country]/designers/[designer]'>): Promise<Metadata> {
	const { designer: slug } = await params;
	const { designer } = await apiQuery(DesignerDocument, {
		variables: { slug },
	});
