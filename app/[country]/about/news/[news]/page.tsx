...
export default async function NewsPage({ params }: PageProps<'/[country]/about/news/[news]'>) {
...
export async function generateMetadata({ params }: PageProps<'/[country]/about/news/[news]'>): Promise<Metadata> {
	const { news: slug } = await params;
	const { news } = await apiQuery(NewsDocument, {
		variables: { slug },
	});
