      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            srcDir = process.env.MM_DEV || process.env.NODE_ENV === "test" ? __dirname + "/.." : __dirname + "/../src"; // copy the emails dir template in!
...
function postHogClient() {
  if (process.env.MM_E2E || process.env.CI || "test" === process.env.NODE_ENV) return;
  if (undefined === client) {
