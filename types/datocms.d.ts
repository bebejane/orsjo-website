...
type AccessoryRecord = RecordInterface & {
  ...
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ItemId']['output'];
  product?: Maybe<ProductAccessoryRecord>;
  updatedAt: Scalars['DateTime']['output'];
};
...
/** Record of type Product lightsource (product_lightsource) */
type ProductLightsourceRecord_allSlugLocalesArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  locale?: InputMaybe<SiteLocale>;
};
...
/** Record of type Product lightsource (product_lightsource) */
type ProductLightsourceRecordslugArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  locale?: InputMaybe<SiteLocale>;
};
